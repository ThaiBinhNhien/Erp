...
$(document).on("click","#onClickAdd", function(){
    ...
    $(this).helloWorld(message_confirm_save_field ,urlIndex,null, 
        {
            url:addListClassifition,
            data:{id:id,name:name,number_container:number_container,number_truck:number_truck,number_max_truck:number_max_truck,classification_customer:classification_customer,classification_base:classification_base},
