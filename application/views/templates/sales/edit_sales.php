...
<table  class="full-table">
    <tbody>
        ...
        <tr style="text-align: right;">
            ...
            <td class="price_cate1 cate1_of_order<?php echo $order->{ID_ORDER_ID} ?>"><?php echo $order->sum_price_cate1 ?></td>
            <td class="price_cate2 cate2_of_order<?php echo $order->{ID_ORDER_ID} ?>"><?php echo $order->sum_price_cate2 ?></td>
        </tr>
        <?php }?>
    </tbody>
</table>
...
<table  class="full-table">
    <tbody>
        ...
        <tr style="text-align: right;">
            <td style="text-align: left;"><?php echo $product->{PL_PRODUCT_CODE_SALE} ?></td>
            <td style="text-align: left;"><?php echo $product->{DD_PRODUCT_NAME} ?></td>
            <td><?php echo $product->{DD_QUANTITY}+0 ?></td>
            <td><?php echo $product->{DD_UNIT_PRICE}+0 ?></td>
            <td class="right-text price"><?php echo $product->{DD_QUANTITY} * $product->{DD_UNIT_PRICE} ?></td>
        </tr>
        <?php }?>
        <tr>
            <td>値引き(%)</td>
...
<table  class="full-table" style="margin-top: 10px">
    <tbody>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td class="right-text no-pad"><input style="text-align: right" class="discount_cate2" value="<?php echo $order->{ID_DISCOUNT_ORTHER} ?>"></td>
        </tr>
    </tbody>
</table>
<?php } else {?>
