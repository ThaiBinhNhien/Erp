        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">商品セットM名 ID:<span class="label-form-request">*</span></label>
                    <div class="col-md-8">
...
<script>
    var addListSetProduct = "<?= base_url("master/setting_shipment_product/add_post") ?>";
