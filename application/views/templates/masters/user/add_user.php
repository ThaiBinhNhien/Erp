    ...
    <form action="" method="POST" id="form_add_user">
        <div class="row first-row">
            <div class="col-md-4 col-sm-6 col-md-offset-2">
                <label class="label-form" >ユーザ名:<span class="label-form-request">*</span></label> <?php if($disable_user){ echo "<input id='form_username' class='right-75' value='{$user[U_ID]}' disabled name='".U_ID."' required>"; } else {?><input  id="form_username" class="right-75"  value="<?php echo isset($user)? $user[U_ID] : ''; ?>" name="<?php echo U_ID; ?>">  <?php } ?>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
             ...
             <div class="col-md-4 col-sm-6 col-md-offset-2">
                <label class="label-form">パスワード:<span class="label-form-request">*</span></label><input class="right-75" value="" name="<?php echo U_PASSWORD; ?>" type="password" id="form_pass">  
            </div>
            <div class="col-md-4 col-sm-6">
                <label class="label-form">パスワード確認:<span class="label-form-request">*</span></label><input class="right-75" value="" name="confirm-password" type="password" id="form_pass_confirm"> 
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-md-offset-2">
                ...
                <select class="form-control right-75" id="form_base" name="<?php echo U_BASE_CODE; ?>">
                    <option></option>
                    <?php 
                    if(isset($baseMaster)) {
...
<script type="text/javascript">
    var addPostMasterUser = "<?= base_url("master/user/add_post") ?>";
