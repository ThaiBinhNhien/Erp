       ...
       <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="form-control no-bottom-margin" id="di_base" name="di_base">
                           <option ></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <span class="form-control form-control-input">
                            <input  class="" id="di_from_date" readonly>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group ">
                    ...
                    <div class="col-md-8">
                        <span class="form-control form-control-input">
                            <input  class="" id="di_to_date" readonly >
                            <span class="icon-large icon-calendar"></span>
                        </span>    
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="form-control no-bottom-margin" id="di_product" name="di_product" >
                           <option ></option>
            ...
            <div class="row">
                <input type="hidden" id="dp_id" />
                   <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <select class="form-control no-bottom-margin cboDisable" id="edit_di_base" name="edit_di_base" disabled>
                               <option></option>
                                  <?php foreach ($list_base as $key => $value) {
                                echo '<option value="'.$value[BM_BASE_CODE].'">'.$value[BM_BASE_NAME].'</option>';
                             } ?> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <span class="form-control-input">
                                <input style="width: 100%;height: 30px;"  class="datepicker" id="edit_di_date" name="edit_di_date" readonly disabled>
                            </span>                           
                            </div>
                        </div>
                 </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label">売上商品名:</label>
                        <div class="col-md-8">
                             <select class="form-control no-bottom-margin cboDisable" id="edit_di_product" name="edit_di_product" disabled>
                               <option></option>
                             <!--      <?php
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <input id="edit_disposal_amount" name="edit_disposal_amount" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <select class="form-control no-bottom-margin" id="create_di_base" name="create_di_base">
                               <option></option>
                                  <?php foreach ($list_base as $key => $value) {
                                echo '<option value="'.$value[BM_BASE_CODE].'">'.$value[BM_BASE_NAME].'</option>';
                             } ?> 
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <span class="form-control-input">
                                <input style="width: calc(100% - 25px);height: 30px;"  class="datepicker" id="create_di_date" name="create_di_date" readonly>
                                 <span class=" icon-large icon-calendar "></span>
                            </span>                           
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                           <!--   <select class="form-control no-bottom-margin" id="create_di_product" name="create_di_product">
                               <option></option>
                                  <?php foreach ($list_product as $key => $value) {
                                echo '<option value="'.$value[PL_PRODUCT_ID].'">'.$value[PL_PRODUCT_NAME].'</option>';
                             } ?>  
                             ...
                             <input class="form-control" name="create_di_product"  id="create_di_product" value="" />
                                <span></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        <label class="col-md-3 control-label">廃棄数:<span class="label-form-request">*</span></label>
                        <div class="col-md-8">
                             <input  id="create_disposal_amount" name="create_disposal_amount" class="form-control">
                        </div>
                    </div>
                </div>
...
<script>
var createUrl = "<?= base_url("master/disposal_inventory/create") ?>";
var catViewUrl = "<?= base_url("master/disposal_inventory/search") ?>";
var edit_CatUrl = "<?= site_url('master/disposal_inventory/edit')?>";
var assetImgUrl = "<?= site_url('asset/img/')?>";
var delUrl = "<?= site_url('master/disposal_inventory/delete')?>";
var message_confirm_delete_field = "<?= $this->lang->line('message_confirm_delete_field')?>";
var urlIndex= "<?= base_url("master/disposal_inventory") ?>";
var url_export = "<?= base_url("master/disposal_inventory/export") ?>";
var url_import = "<?= base_url("master/disposal_inventory/import") ?>";
