    ...
    <form class="form-horizontal" role="form" >
         <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">仕入先区分ID:</label>
                    <div class="col-md-8">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">仕入先区分名:</label>
                    <div class="col-md-8">
         ...
         <form class="form-horizontal" role="form" id="edit_form">
            <div class="row">
              <div class="col-md-12 col-xs-12 form-group pad10">
                    <div class="col-md-12 col-xs-12 form-group pad10">
                        <div class="col-md-3 col-md-offset-1"><label class="control-label">仕入先区分ID:</label>
</div>
                        <div class="col-md-6">
              ...
              <div class="col-md-12 col-xs-12 form-group pad10">
                    <div class="col-md-12 col-xs-12 form-group pad10">
                        <div class="col-md-3 col-md-offset-1"><label class="control-label">仕入先区分名:<span class="label-form-request">*</span></label>
</div>
                        <div class="col-md-6">
         ...
         <form class="form-horizontal" role="form" id="form">
            <div class="row">
              <div class="col-md-12 col-xs-12 form-group pad10">
                ...
                <div class="col-md-12 col-xs-12 form-group pad10">
                    <div class="col-md-3 col-md-offset-1"><label class="control-label">仕入先区分ID:<span class="label-form-request">*</span></label>
</div>
                    <div class="col-md-6">
...
<script>
var createUrl = "<?= base_url("master/supplier_category/create_category") ?>";
var catViewUrl = "<?= base_url("master/supplier_category/search_category") ?>";
var edit_CatUrl = "<?= site_url('master/supplier_category/edit_category')?>";
var assetImgUrl = "<?= site_url('asset/img/')?>";
var delUrl = "<?= site_url('master/supplier_category/delete_category')?>";
var message_confirm_delete_field = "<?= $this->lang->line('message_confirm_delete_field')?>";
var urlIndex= "<?= base_url("master/supplier_category") ?>";
var url_export = "<?= base_url("master/supplier_category/export") ?>";
var url_import = "<?= base_url("master/supplier_category/import") ?>";
</script>
