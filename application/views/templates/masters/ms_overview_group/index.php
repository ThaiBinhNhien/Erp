    ...
    <form class="form-horizontal" role="form">
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-5 control-label">生産概要グループID  :</label>
                    <div class="col-md-7">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-5 control-label">生産概要グループ名 :</label>
                    <div class="col-md-7">
        ...
        <form class="form-horizontal" role="form" id="form_add_category">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <label class="col-md-4 control-label">生産概要グループID:<span class="label-form-request">*</span></label>
                        <div class="col-md-5">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <label class="col-md-4 control-label">生産概要グループ名:<span class="label-form-request">*</span></label>
                        <div class="col-md-5">
...
<script>
    var getListLink = "<?= base_url("master/overview_group_m/get_list") ?>";
    var editPostLink = "<?= base_url("master/overview_group_m/edit_post") ?>";
    var addPostLink = "<?= base_url("master/overview_group_m/add_post") ?>";
    var deleteLink = "<?= base_url("master/overview_group_m/delete_post") ?>";
    ...
    var urlIndex = "<?= base_url("master/overview_group_m") ?>";
    var url_export = "<?= base_url("master/overview_group_m/export") ?>";
    var url_import = "<?= base_url("master/overview_group_m/import") ?>";
</script>
