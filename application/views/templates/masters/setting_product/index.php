...
<div class="wrapper-contain order" id="receive-order">
  <div class="col-md-8 third-row">
    ...
    <form class="form-horizontal" role="form">
             <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">商品セットID :</label>
                    <div class="col-md-8">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">商品セット名:</label>
                    <div class="col-md-8">
        ...
        <form class="form-horizontal" role="form" id="form_import_csv" method="POST" enctype="multipart/form-data">    
            ...
            <div class="col-md-3">
                <select class="form-control" name="get_type_csv" id="get_type_csv" style="    width: 100%;">
                    <option value="1">商品セット</option>
                    <option value="2">商品セット-商品</option>
                </select>
            </div>
            <div class="col-md-2"> 
    ...
    <div class="row right third-row">
        <a href="<?= base_url("master/setting_product/add") ?>" target="_blank" class="print">新規追加</a>
    </div>
    <div class="clearfix"></div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title modal-title-add">商品セット　編集・新規追加</h4>
      </div>
...
<script>
    var getListSetProduct = "<?= base_url("master/setting_product/get_list") ?>";
    var editSetProduct = "<?= base_url("master/setting_product/edit") ?>";
    var deleteListSetProduct = "<?= base_url("master/setting_product/delete_post") ?>";
    ...
    var url_export = "<?= base_url("master/setting_product/export") ?>";
    var url_import = "<?= base_url("master/setting_product/import") ?>";
