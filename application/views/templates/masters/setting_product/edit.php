        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                       <input class="form-control" name="id_edit_set_product" id="id_edit_set_product" value="<?php echo $data_meta[0][PS_PRODUCT_SET_CODE]; ?>" disabled />
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                       <input class="form-control" name="name_set_product" id="name_set_product" value="<?php echo $data_meta[0][PS_PRODUCT_SET_NAME]; ?>" />
                    </div>
                </div>
            </div>
...
<script>
    var editListSetProduct = "<?= base_url("master/setting_product/edit_post") ?>";
