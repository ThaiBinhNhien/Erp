        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                    <label class="col-md-3 control-label">受発注専用得意先ID:</label>
                    <div class="col-md-5">
                        <input class="form-control "  disabled="true" name="group_id" id="group_id" value="<?= $customer[CSHIPMENT_ID]?>" >
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input class="form-control " name="group_name" id="group_name" value="<?= $customer[CSHIPMENT_NAME]?>" >
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                    <label class="col-md-3 control-label">得意先 :</label>
                    <div class="col-md-5">
                        <select class="form-control selectpicker"  name="group_customer"  id="group_customer" data-live-search="true" multiple >
                                ...
                                foreach ($list_customer as $key => $value) {
                                    ...
                                    foreach ($id_customer as $keyCus => $valueCus) {
                                        if($value[CUS_ID] == $valueCus[CUS_ID]) {
                                            $selected = "selected";
                                        }
                                    }
                                }
                                        echo '<option value="'.$value[CUS_ID].'" title="'.$value[CUS_CUSTOMER_NAME].'" '.$selected.'>'.$value[CUS_CUSTOMER_NAME].'</option>';
                                    } } ?>
                            </select>
                    </div>
                </div>
            ...
            <table  width="100%" >
                <tbody id="department" >
                   ...
                   foreach ($lstDepartment as $key => $value) {?>
                    <?php if(!in_array($value[DSL_DEPARTMENT_CODE],array_column($department,CDS_DEPARTMENT_CODE))) {?>
                    <tr>
            ...
            <table  width="100%" >
                <tbody id="detail" >
                    ...
                    foreach ($department as $key => $value) {?>
                        <tr>
                         <td width="20%"><input type="hidden" value="<?= $value[CDS_DEPARTMENT_CODE] ?>" class="id_dp" /> <?= $value[CDS_DEPARTMENT_CODE] ?></td>
                         <td><?= $value[DSL_DEPARTMENT_NAME] ?></td>
                         </tr>
                   <?php } } ?>
                </tbody>
...
var cusId = <?= $customer[CSHIPMENT_ID] ?>;
