    ...
    <table width="100%" class="table">
        <thead>
            <tr>
                ...
                <th width="10%" class="text-right border-bottom2 color030a84 size120">数量合計</th>
        ...
        <tbody>
            ...
            <?php if(isset($group_product)) {
				...
				foreach ($detail as $keyDetail => $valueDetail) {
                    if($valueDetail["group_code"] == $category['group_code'] && $valueDetail["product_code"] == $value['product_code']) {
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">&nbsp;</td>
                        <td class="text-center">&nbsp;</td>
                        <td class="text-center"><?php echo $valueDetail['department_code']; ?></td>
                        <td class="text-center"><?php echo $valueDetail['department_name']; ?></td>
