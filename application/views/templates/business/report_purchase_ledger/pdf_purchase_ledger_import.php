...
<div>
    <table width="100%">
        <thead>
            <tr>
                <th colspan="2" class="size110 borTopIn">&nbsp;仕入先名</th>
                <th colspan="2" class="size110 borTopIn text-left">&nbsp;販売先名</th>
            ...
            <tr>
                <th width="14%" class="size110 borBotIn">&nbsp;日付</th>
                <th width="20%" class="size110 borBotIn text-center">商品名</th>
                <th width="14%" class="size110 borBotIn">備考</th>
                <th width="10%" class="size110 borBotIn">色調</th>
                <th width="8%" class="size110 borBotIn">規格</th>
                <th width="10%" class="size110 borBotIn text-right">数量</th>
                <th width="12%" class="size110 borBotIn text-right">仕入単価</th>
                <th width="12%" class="size110 borBotIn text-right">支払金額</th>
            </tr>
        </thead> 
        <tbody>
            <?php
            ...
            <?php
                ...
                ?>
            <tr>
                <td class="borderDotted"><?php echo $valueDetail["detail_date"]; ?></td> 
                <td class="borderDotted"><?php echo $valueDetail["product_buy_code"]; ?> <?php echo $valueDetail["product_buy_name"]; ?></td>
                ...
                <td class="borderDotted text-right"><?php echo number_format($valueDetail["number_import"],0,",",","); ?></td>
