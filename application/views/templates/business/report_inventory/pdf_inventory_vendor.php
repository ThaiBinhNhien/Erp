            ...
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="15%" class="size120 borTopIn borBotIn text-right">&nbsp;</th>
                        <th width="17%" class="size120 text-right borTopIn borBotIn text-left">&nbsp;</th>
                    </tr>
                </thead> 
                <tbody> 
                    ...
                    ?>
                    <tr>
                        <td colspan="8" class="borTopInBig borBotInBig" style="font-weight: bold;font-size: 18px;"><?php echo $valueCompany['company_name']; ?></td>
                    </tr>
                    ...
                    ?>
                    <tr>
                        <td colspan="8" class="borTopInL borBotInL" style="font-weight: bold;font-size: 18px;"><?php echo $valueCategory['category_buy_name']; ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class=""><?php echo $valueProduct['base_name']; ?></td>
                    </tr>
                    <tr>
